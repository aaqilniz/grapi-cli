...
running command...
$ grapi-cli (--version)
grapi-cli/1.0.0 linux-x64 node-v18.17.1
...
_See code: [src/commands/app.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/app.ts)_
...
_See code: [src/commands/auth.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/auth.ts)_
...
_See code: [src/commands/auth/users.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/auth/users.ts)_
...
```
USAGE
  $ grapi-cli cache [-c <value>] [--redisDS <value>] [--TTL <value>] [--specURL <value>] [--prefix <value>]
    [--openapi <value>] [--exclude <value>] [--include <value>] [--readonly <value>]
...
FLAGS
  -c, --config=<value>    Config JSON object
      ...
      --readonly=<value>  readonly controllers
      --redisDS=<value>   redisDS
      --specURL=<value>   specURL name

DESCRIPTION
  creating cache for endpoints
```

_See code: [src/commands/cache.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/cache.ts)_
...
_See code: [src/commands/controller.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/controller.ts)_
...
_See code: [src/commands/copyright.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/copyright.ts)_
...
_See code: [src/commands/datasource.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/datasource.ts)_
...
_See code: [src/commands/discover.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/discover.ts)_
...
_See code: [src/commands/example.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/example.ts)_
...
_See code: [src/commands/extension.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/extension.ts)_
...
USAGE
  $ grapi-cli external:operation [-c <value>] [--ds <value>] [--method <value>] [--bodyParams <value>] [--pathParams
    <value>] [--url <value>] [--headers <value>] [--query <value>] [--apiFunction <value>] [--name <value>] [--type
    <value>] [--apiUri <value>]

FLAGS
  -c, --config=<value>       Config JSON object
      --apiFunction=<value>  api function name.
      --apiUri=<value>       uri of the specific api.
...
_See code: [src/commands/external/operation.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/external/operation.ts)_
...
_See code: [src/commands/fuzzy.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/fuzzy.ts)_
...
_See code: [src/commands/import-lb3-models.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/import-lb3-models.ts)_
...
_See code: [src/commands/interceptor.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/interceptor.ts)_
...
_See code: [src/commands/model.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/model.ts)_
...
_See code: [src/commands/model/remove.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/model/remove.ts)_
...
_See code: [src/commands/observer.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/observer.ts)_
...
_See code: [src/commands/openapi.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/openapi.ts)_
...
_See code: [src/commands/property/add.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/property/add.ts)_
...
_See code: [src/commands/property/remove.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/property/remove.ts)_
...
_See code: [src/commands/relation.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/relation.ts)_
...
_See code: [src/commands/repository.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/repository.ts)_
...
_See code: [src/commands/rest-crud.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/rest-crud.ts)_
...
_See code: [src/commands/service.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/service.ts)_
...
_See code: [src/commands/sql-controller.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/sql-controller.ts)_
...
_See code: [src/commands/update.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/update.ts)_
...
_See code: [src/commands/update/model.ts](https://github.com/aaqilniz/grapi-cli/blob/v1.0.0/src/commands/update/model.ts)_
<!-- commandsstop -->
