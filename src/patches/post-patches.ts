...
export const patches: Patch = {
    ...
    supportGroupBy: {
        addBuildGroupByQuery: {
            ...
            path: '/loopback-connector/lib/sql.js',
        },
        addExtraQuery: {
        ...
        addData: {
            ...
            path: '/loopback-datasource-juggler/lib/dao.js',
        },
        exportGroupBy: {
            ...
            path: '/loopback-datasource-juggler/lib/utils.js',
        },
        createGroupByUtil: {
        ...
        addAggregateToFilterSchema: {
            ...
            path: '/@loopback/repository-json-schema/dist/filter-json-schema.js',
        },
        addToWriter: {
